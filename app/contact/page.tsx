  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      content: 'florian.bounissou@etu.unilim.fr',
      link: 'mailto:florian.bounissou@etu.unilim.fr'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'GitHub',
      content: 'github.com/florianMMI',
      link: 'https://github.com/FlorianMMI'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 transition-colors duration-300">
                  ...
                  autour du développement web et des technologies. N'hésitez pas à me contacter !
                </p>
              </div>
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 transition-colors duration-300"
            >
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 transition-colors duration-300">Envoyez-moi un message</h2>
